						...
						<div class="col-12 col-sm-6 col-lg-3 item">
							...
							<div class="footer-items">
								...
								<a class="navbar-brand" href="index.php">
									...
									<img class="logo footer-logo" src="assets/img/logo/footer-logo.png" alt="">

								</a>

								<p class="slug mt-3">High-quality construction materials for durable, reliable, and efficient building projects.
					...
					<div class="row">
						...
						<div class="col-12">
							...
							<div class="copyright-area d-flex flex-wrap justify-content-center justify-content-sm-between align-items-center text-center py-4">
								...
								<span>&copy; 2024 <a href="index.php" style="color: var(--primary-color);"> Aggzon </a> | All rights reserved.</span>

								<span>Design & Develop By <a href="http://maishainfotech.com/" target="_blank" rel="noopener noreferrer">Maisha Infotech PVT LTD</a></span>
	...
	<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script> <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js" integrity="sha512-v2CJ7UaYy4JwqLDIrZUI/4hqeoQieOmAZNXBeQyjo21dadnwR+8ZaIJVT8EE2iyI61OV8e6M8PP2/4hpQINQ/g==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
